				...
				yamlls = {
					settings = {
						yaml = {
							-- Schemas https://www.schemastore.org
							schemas = {
								["http://www.schemastore.org/gitlab-ci.json"] = { ".gitlab-ci.yml" },
								["https://www.schemastore.org/bamboo-spec.json"] = {
									"bamboo-specs/*.{yml,yaml}",
								},
								["https://raw.githubusercontent.com/compose-spec/compose-spec/master/schema/compose-spec.json"] = {
									"docker-compose*.{yml,yaml}",
								},
								["http://www.schemastore.org/github-workflow.json"] = ".github/workflows/*.{yml,yaml}",
								["http://www.schemastore.org/github-action.json"] = ".github/action.{yml,yaml}",
								["http://www.schemastore.org/prettierrc.json"] = ".prettierrc.{yml,yaml}",
								["http://www.schemastore.org/stylelintrc.json"] = ".stylelintrc.{yml,yaml}",
								["http://www.schemastore.org/circleciconfig"] = ".circleci/**/*.{yml,yaml}",
								["http://www.schemastore.org/lazydocker.json"] = "lazydocker/**/*.{yml,yaml}",

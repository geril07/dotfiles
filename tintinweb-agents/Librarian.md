...
- Search broadly, then read what matters. Use exa web search, GitHub code search (grep app), and web fetching to find official docs, source files, and real-world usage examples.
